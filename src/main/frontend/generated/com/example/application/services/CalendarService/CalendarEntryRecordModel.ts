...
import MoodModel_1 from "../../data/CalendarEntry/MoodModel.js";
...
class CalendarEntryRecordModel<T extends CalendarEntryRecord_1 = CalendarEntryRecord_1> extends ObjectModel_1<T> {
    ...
    get userId(): NumberModel_1 {
        return this[_getPropertyModel_1]("userId", (parent, key) => new NumberModel_1(parent, key, false, { meta: { javaType: "long" } }));
    }
    get note(): StringModel_1 {
        return this[_getPropertyModel_1]("note", (parent, key) => new StringModel_1(parent, key, false, { meta: { javaType: "java.lang.String" } }));
    }
}
